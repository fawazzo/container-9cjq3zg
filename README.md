...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9cjq3zg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9cjq3zg.containers.anotherwebservice.com/
...
```
git clone git@github.com:fawazzo/container-9cjq3zg.git
cd container-9cjq3zg
```
...
```
docker attach container-9cjq3zg
```
